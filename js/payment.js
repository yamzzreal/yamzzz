...
async function init() {
  ...
  setInterval(async () => {
    ...
    const el = document.querySelector(".payment-head .payment-note span");
    if (el) el.textContent = DB.site?.notification || oldNotification || "";
    else if (DB.site?.notification) render();
  }, 15000);
