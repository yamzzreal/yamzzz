...
function renderResult(order){
 ...
 ${order.status==="paid"&&order.deliveryLink?`<a class="contact-btn" target="_blank" rel="noopener noreferrer" href="${esc(order.deliveryLink)}"><i class="fa-solid fa-link"></i> Buka Link Produk</a>`:""}
