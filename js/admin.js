...
window.Admin={
  ...
  renderAll(){this.renderStats();this.renderProducts();this.renderOrders();this.renderSettings();this.renderInformation()},
  renderStats(){
