...
window.Admin={
  ...
  open(section,button){
    ...
    $("#pageTitle").textContent={dashboard:"Dashboard",products:"Produk",orders:"Transaksi",testimonials:"Testimoni",information:"Informasi",settings:"Pengaturan"}[section]||"Admin";
    this.closeSidebar();
  },
  renderAll(){this.renderStats();this.renderCategories();this.renderProducts();this.renderOrders();this.renderTestimonials();this.renderSettings();this.renderInformation()},
